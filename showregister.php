...
?>
            ...
            <center>
 <h1>--------Manage Registration--------</h1></center>
                            </div>
                  ...
                  <tr>
                      <th align="center"><font size="2px">Register Id</font></th>
                    <th align="center"><font size="2px">Name</font></th>
                    <th align="center"><font size="2px">City </font></th>
               ...
               <?php 
                  ...
                  <tr>
                    ...
                    <td align="center"><a href="deleteregister.php?id=<?php echo $row[0]; ?>">Delete</a></td>
                    <?php
