...
session_start();
    ...
    <div class="booking-row content-padding-xs">
      ...
      <div class="container"> 
            ...
            <div style="background-color:rgba(233, 189, 162, 0.69); width:1460px; height:50px; margin-left:-110px;">
            <center>
...
$er=0;
	...
	$qry="insert into registration (full_name,city_id,mo_no,email,user_type,password)values('$name','$city','$contact','$email','0','$pwd')";
...
<table  border="0" cellpadding="0" cellspacing="0" align="center" width="500">
                            ...
                            <tr>
                             <td valign="top" align="center" colspan="2"><h3><b>Add Bus</b></h3></td>
                 </tr>
                         <tr><td><br></td></tr>
                            
                              <tr>
			  <td> User Full Name:</td>
			  <td><input type="text" name="name" value="" style="width:200px;" />
				</td> 
			</tr>
			<tr>
			  <td>City Name:</td>
			  <td>
             <select id="cityname" name="cityname" style="width:200px;">
          ...
          <?php
            ...
            <tr>
			  <td>Mobile Number:</td>
			  <td><input type="text" name="mo" style="width:200px;"></textarea></td>
			</tr>
             <tr>
			  <td>Email Address:</td>
			  <td><input type="text" name="mail" style="width:200px;"></textarea></td>
			</tr>
             <tr>
			  <td>Enter Password:</td>
			  <td><input type="text" name="pass" style="width:200px;"></textarea></td>
			</tr>
             <tr>
			  <td>Re-Type Password:</td>
			  <td><input type="text" name="repass" style="width:200px;"></textarea></td>
			</tr>
			
                         <tr><td><br></td></tr>
                         <tr align="center">
                             <td colspan="2"><input name="submit" type="submit" value="submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp
