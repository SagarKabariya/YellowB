...
session_start();
    ...
    $data=  mysql_query("select * from bus");
?>
...
<table border="0" cellpadding="0" cellspacing="0" align="center">
 ...
 <h1>--------Manage Bus--------</h1></center>
                                ...
                                <form  action="" name="state" method="post" >
										...
										<tr>
											<td colspan="7" align="right"><div style="margin-left:550px; background-color:#D5D5D5; width:150px; height:20px;"><a href="addbus.php" class="button" >Add New Bus</a></div></td>
											
										</tr>
                                    <tr align="center">
                                        
                                                <th> <font size="2px">Bus Id</font></th>
                                                 <th> <font size="2px">Bus Name</font></th>
                                                   <th> <font size="2px">Bus Number</font></th>
                                                    <th> <font size="2px">Number Of Seat</font></th>
                                                     <th> <font size="2px">Bus Type</font></th>
                    ...
                    ?>
                     ...
                     <tr align="center">
                                    ...
                                    <td><font size="2px"><a href="updatebus.php?id=<?php echo $row[0]; ?>">Update</a></font></td>
                                    <td><a href="deletebus.php?id=<?php echo $row[0]; ?>">Delete</a></td>
                    </tr>
