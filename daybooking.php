...
session_start();
    ...
    $data=  mysql_query("select * from book where book_date='".$date."' order by book_id desc");
?>
								...
								<?php
									if(isset($_POST['submit']))
									{
										...
										$datt=$_POST['tjdate'];
										$qry=mysql_query("select * from book where book_date=' ".$datt." '");
									}
								?>
...
<table border="0" cellpadding="0" cellspacing="0" align="center">
 ...
 <h1>--------Manage Booking--------</h1></center>
                                ...
                                <form  action="showbook.php" name="state" method="post" >
                                        <table height="50%" width="70%" border="0" align="center" style="padding-left: 100px;">
										<div class="col-md-3 col-sm-6 icon-calendar" style="width:200px;">
													...
													<tr>
											<td colspan="9" align="right"><div style="margin-left:550px; background-color:#D5D5D5; width:150px; height:20px;"><a href="showallbook.php" class="button" >Show all booking</a></div></td>
