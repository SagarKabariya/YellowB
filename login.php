...
session_start();
	...
	<div style="background-color:rgba(245, 202, 170, 0.4); width:960px; height:260px">
    <div style="font-size:100px; font-family:'Alex Brush'; color:#900">
<center>
		Login in yellowb.com
	</center>
    </div>
  <form id="booking-form" method="post">
             
            <div class="col-md-3 col-sm-6 icon-calendar" style="width:250px; margin-left:150px;">
              
              <input type="text" class="form-control" placeholder="From" id="name" name="name" >
            </div>
            <div class="col-md-3 col-sm-6 icon-calendar" style="width:250px;">
              
              <input type="password" class="form-control" id="pass" placeholder="To" name="pass">
            </div>
...
if(isset($_POST['login']))
{
  ...
  if(!empty($userid) && !empty($pass))
  {
	 ...
	 $query="select register_id,full_name,password,user_type from registration where full_name='$userid' and password='$pass'";
	 ...
	 if($r=mysql_fetch_assoc($result))
	 {
		...
		else if($vutype=="1")
		{
			...
			$_SESSION["uid"]=$uid;
			$_SESSION["utype"]=$vutype;
			header("Location: http://localhost/yellowB/admin.php");		
		}
