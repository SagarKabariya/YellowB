 ...
 <h1>--------Manage city--------</h1></center>
                                ...
                                <form  action="" name="state" method="post" >
                                     <table height="50%" width="50%" border="0" align="center" style="padding-left: 100px;">
										<tr>
											<td colspan="7" align="right"><div style="margin-left:550px; background-color:#D5D5D5; width:150px; height:20px;"><a href="addcity.php" class="button" >Add New City</a></div></td>
										</tr>
                                    <tr align="center">
                    ...
                    ?>
                     ...
                     <tr align="center">
                                    ...
                                    <td><font size="2px"><a href="updatecity.php?id=<?php echo $row[0]; ?>">Update</a></font></td>
