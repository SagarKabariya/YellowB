...
$er=0;
        ...
        if(isset($_REQUEST['save']))
        {
            ...
            if($er!=1 && $f!=1)
            {
                $in=  mysql_query("insert into bus values(0,'$_REQUEST[bname]','$_REQUEST[bnumber]','$_REQUEST[noofseat]','$_REQUEST[type]')");
                header('location:showbus.php');
            }
...
<table  border="0" cellpadding="0" cellspacing="0" align="center" width="300">
			...
			<tr>
			  <td>Bus Number:</td>
			  <td><input type="text" name="bnumber" value="" />
				</td>
			</tr>
            <tr>
			  <td>Number Of Seat:</td>
			  <td><input type="text" name="noofseat"></textarea></td>
			</tr>
			<tr>
			  <td>Bus Type:</td>
			  <td><select name="type">
