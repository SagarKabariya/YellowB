...
$er=0;
        ...
        if(isset($_REQUEST['save']))
        {
            ...
            if($er!=1 && $f!=1)
            {
                ...
                $in=  mysql_query("insert into route (`source_id`,`destination_id`,`bus_id`,`fare`) values('$_REQUEST[scityname]','$_REQUEST[dcityname]','$_REQUEST[bus]','$_REQUEST[txtfare]')");
                header('location:showroot.php');
            }
